  ...
  <div>
    ...
    <div className="mb-9 mt-6 space-y-1.5">
      ...
      <p className="text-zinc-400">
        Sell your private github repos!{" "}
        <span href="#" className="text-blue-400">
          Make money <span className="text-green-300">$</span>.
        </span>
      </p>
    </div>
  </div>
...
const githubClientId = import.meta.env.VITE_GITHUB_APP_CLIENT_ID;
const githubRedirecUri = `${import.meta.env.VITE_BACKEND_SERVER}${
  import.meta.env.VITE_GITHUB_APP_REDIRECT_URI
}`;

const SocialOptions = () => {
  const handleSignInWithGithub = () => {
    const authUrl = `https://github.com/login/oauth/authorize?client_id=${githubClientId}&redirect_uri=${githubRedirecUri}&scope=user:email,repo`;
